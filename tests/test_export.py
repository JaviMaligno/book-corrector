...
r_login = requests.post(
    "http://localhost:8000/auth/login", json={"email": "demo@example.com", "password": "demo123"}
)
token = r_login.json()["access_token"]
r_export = requests.post(
    "http://localhost:8000/suggestions/runs/88d6a06f-6179-4979-81eb-b2d573b6c97a/export-with-accepted",
